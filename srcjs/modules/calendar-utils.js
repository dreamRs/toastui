...
function clickPrev(calendar, renderRange, formatNav) {
  return function (event) {
    if (calendar !== null) {
      calendar.prev();
      renderRange.innerHTML = formatDateNav(calendar, formatNav);
...
function clickNext(calendar, renderRange, formatNav) {
  return function (event) {
    if (calendar !== null) {
      calendar.next();
      renderRange.innerHTML = formatDateNav(calendar, formatNav);
...
function clickToday(calendar, renderRange, formatNav) {
  return function (event) {
    if (calendar !== null) {
      calendar.today();
      renderRange.innerHTML = formatDateNav(calendar, formatNav);
...
export function addNavigation(calendar, id, options) {
  ...
  prev.removeEventListener(
    "click",
    clickPrev(calendar, renderRange, formatNav)
  );
  prev.addEventListener("click", clickPrev(calendar, renderRange, formatNav));
  ...
  next.removeEventListener(
    "click",
    clickNext(calendar, renderRange, formatNav)
  );
  next.addEventListener("click", clickNext(calendar, renderRange, formatNav));
  ...
  today.removeEventListener(
    "click",
    clickToday(calendar, renderRange, formatNav)
  );
  today.addEventListener("click", clickToday(calendar, renderRange, formatNav));
