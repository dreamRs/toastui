...
Sort is enabled by default, you can diable it like this:
...
in the same way you can apply styles to an antire row:
...
Set styles on an entire columns based on its values, here for exemple we use `scales::col_numeric()` to create a color gradient:
